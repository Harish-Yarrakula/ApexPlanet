 document.addEventListener('DOMContentLoaded', function() {
            ...
            todoList.innerHTML = todos.map(todo => `
                <div class="todo-item">
                    ...
                    <div class="todo-actions">
                        <button onclick="editTodo(${todo.id})" title="Edit">✏️</button>
                        <button onclick="deleteTodo(${todo.id})" title="Delete">🗑️</button>
                    </div>
                </div>
            `).join('');
        }
        ...
        const products = [
            ...
            { id: 11, name: "Garden Tools Set", category: "home", price: 79, rating: 4.4, image: "🛠️" },
